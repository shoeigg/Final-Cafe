    ...
    <section class="ftco-section">
        ...
        <div class="row">
        	<div class="col-md-6 mb-5 pb-3">
        		<h3 class="mb-5 heading-pricing ftco-animate">Other Coffee Menu</h3>
        	...
        	<div class="col-md-6">
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			...
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
	        				<h3><span>Strawberry Pancakes</span></h3>
	        				<span class="price">$20.00</span>
	        			</div>
	        			<div class="d-block">
	        				<p></p>
        	...
        	<div class="col-md-6">
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			...
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
	        				<h3><span>STRAWBERRY　JUICE</span></h3>
	        				<span class="price">$20.00</span>
	        			</div>
	        			<div class="d-block">
	        				<p></p>
